...
class ProductList extends Component{
  ...
  constructor(renderHookId){
    ...
    this.#fetchProducts();    // private method
  }
...
class Cart extends Component{
  ...
  constructor(renderHookId){
    ...
    this.orderHandler = () => {
      ...
      console.log(this.items);     //arrow fn, so 'this' here refers correctly to access items  
    }
    this.createElAndRender();
  }
  ...
  // another method is to use this fn as arrow fn
  // but properties are not avaialable 'cause render is called in parent class constructor
  // so we have to delay the rendering of element and move that property to constructor before rendering

  // orderHandler(){
  //   console.log('Ordering....');
  //   console.log(this.items);     //without binding or using arrow fns, 'this' here refers to button  
  // }
  createElAndRender(){
    ...
    // orderBtn.addEventListener('click',() => this.orderHandler());     // using arrow fn, refer to exact same thing it would refer outside the fn
    // orderBtn.addEventListener('click',this.orderHandler.bind(this));   // another way
...
class Shop {
  createElAndRender(){
    ...
    new ProductList('app');
    //cannot access prodList.products here as products is a private field
  }
}
